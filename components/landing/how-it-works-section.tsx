function StepCard({ number, title, description }: { number: string; title: string; description: string }) {
  return (
    <div className="flex flex-col items-center gap-6 text-center">
      <div
        className="flex h-16 w-16 items-center justify-center rounded-2xl border border-neon/30 bg-neon/5 text-2xl font-bold text-neon"
        style={{ boxShadow: "0 0 30px rgb(var(--neon) / 0.1)" }}
      >
        {number}
      </div>
